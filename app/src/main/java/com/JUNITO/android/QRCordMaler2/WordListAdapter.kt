...
import com.JUNITO.android.QRCordMaler2.WordListAdapter.WordViewHolder
...
class WordListAdapter : ListAdapter<Word, WordViewHolder>(WORDS_COMPARATOR) {
    ...
    class WordViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(text: String?) {
            ...
            val read_btn:Button=itemView.findViewById(R.id.read_btn)
            ...
            read_btn.setOnClickListener {
                ...
                val instxt=wordItemView.text.toString()
                //intent.putExtra("TEXT_KEY",instxt)
                context.startActivity(Intent(context, NewWordActivity::class.java).putExtra("TEXT_KEY",instxt))
            }
